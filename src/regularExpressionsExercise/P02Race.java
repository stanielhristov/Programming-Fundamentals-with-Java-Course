...
public class P02Race {
    public static void main(String[] args) {
        ...
        List<String> top3Names = racerDistances.entrySet().stream().sorted(Map.Entry.comparingByValue(Comparator.reverseOrder())).limit(3).map(entry -> entry.getKey()).collect(Collectors.toList());
