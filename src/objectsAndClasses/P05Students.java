...
public class P05Students {
    ...
    public static void main(String[] args) {
        ...
        while(!inputLine.equals("end")) {
            String[] arrayStudentData = inputLine.split("\\s+");
            String firstName = arrayStudentData[0];
            String lastName = arrayStudentData[1];
            int age = Integer.parseInt(arrayStudentData[2]);
            String town = arrayStudentData[3];
